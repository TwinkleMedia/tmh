...
export default function Home() {
 ...
 const portfolioImages = [
    { src: "/asset/homeSlider/img1.png", alt: "Digital marketing campaign showcase - TMH Media portfolio" },
    { src: "/asset/homeSlider/img2.png", alt: "Brand identity design project - Creative branding solutions" },
    { src: "/asset/homeSlider/img3.png", alt: "Social media marketing content - Instagram and Facebook ads" },
    { src: "/asset/homeSlider/img4.png", alt: "Commercial video production - Professional ad filming" },
    { src: "/asset/homeSlider/img5.png", alt: "SEO optimization results - Organic traffic growth" },
    { src: "/asset/homeSlider/img6.png", alt: "Website development project - Responsive web design" },
    { src: "/asset/homeSlider/img7.png", alt: "E-commerce marketing campaign - Online sales strategy" },
    { src: "/asset/homeSlider/img8.png", alt: "Corporate branding project - Logo and identity design" },
    { src: "/asset/homeSlider/img9.png", alt: "Social media content creation - Engaging visual posts" },
    { src: "/asset/homeSlider/img10.png", alt: "Digital advertising campaign - PPC and display ads" },
    { src: "/asset/homeSlider/img11.png", alt: "Video marketing content - YouTube and social video" },
    { src: "/asset/homeSlider/img12.png", alt: "Print media design - Brochures and marketing materials" },
    { src: "/asset/homeSlider/img13.png", alt: "Influencer marketing campaign - Brand collaborations" },
    { src: "/asset/homeSlider/img14.png", alt: "Email marketing design - Newsletter and promotional emails" },
    { src: "/asset/homeSlider/img15.png", alt: "Mobile app marketing - App store optimization" },
    { src: "/asset/homeSlider/img16.png", alt: "Content marketing strategy - Blog and article writing" },
    { src: "/asset/homeSlider/img17.png", alt: "Photography services - Product and commercial photography" },
    { src: "/asset/homeSlider/img18.png", alt: "Graphic design portfolio - Creative visual solutions" },
    { src: "/asset/homeSlider/img19.png", alt: "Brand strategy consultation - Market positioning" },
    { src: "/asset/homeSlider/img20.png", alt: "Social media management - Community engagement" },
    { src: "/asset/homeSlider/img21.png", alt: "Video editing services - Post production and effects" },
    { src: "/asset/homeSlider/img22.png", alt: "Packaging design - Product branding and labels" },
    { src: "/asset/homeSlider/img23.png", alt: "Digital analytics - Marketing performance tracking" },
    { src: "/asset/homeSlider/img24.png", alt: "Event marketing - Promotional campaigns and coverage" },
    { src: "/asset/homeSlider/img25.png", alt: "UI/UX design - User experience optimization" },
    { src: "/asset/homeSlider/img26.png", alt: "Marketing automation - CRM and lead generation" },
  ];
  return (
