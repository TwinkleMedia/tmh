...
function Careerpage() {
  ...
  return (
    <>
      <Helmet>
        <title>Career at Twinkle Media Hub | Digital Marketing Jobs in Navi Mumbai</title>

        <meta
          name="description"
          content="Apply for SEO jobs, Social Media Marketing jobs, Web Development jobs, Video Editing jobs and Designing jobs at Twinkle Media Hub in Navi Mumbai. Grow your digital marketing career with us."
        />

        <meta
          name="keywords"
          content="digital marketing jobs navi mumbai, seo jobs mumbai, social media marketing jobs, web developer jobs navi mumbai, video editor jobs, career twinkle media, jobs in cbd belapur"
        />

        <link rel="canonical" href="https://www.twinklemediahub.com/career" />

        {/* 📌 Open Graph for Social Sharing */}
        <meta property="og:title" content="Career at Twinkle Media Hub | Digital Marketing Jobs" />
        <meta property="og:description" content="Join one of Navi Mumbai's fastest-growing digital marketing companies. Apply now for SEO, SMM, Web Development & Designing Positions." />
        <meta property="og:image" content="https://www.twinklemediahub.com/asset/logo.png" />
        <meta property="og:url" content="https://www.twinklemediahub.com/career" />
        <meta property="og:type" content="website" />

        {/* 📌 Twitter SEO */}
        <meta name="twitter:title" content="Career at Twinkle Media Hub" />
        <meta name="twitter:description" content="Explore digital marketing job opportunities at Twinkle Media Hub." />
        <meta name="twitter:card" content="summary_large_image" />
      </Helmet>
      <div className="career-container">
        <h1 className="career-header">
          Build Your Career with <span>Twinkle Media Hub</span>
        </h1>
        <p className="section-description" id="career-sub-heading">
          Join one of Navi Mumbai’s top Digital Marketing Agencies and grow your skills in SEO, Social Media, Web Development, Video Editing & Designing.
        </p>
          ...
          <div className="career-content">
            ...
            <div className="form-section">
              ...
              <div>
                ...
                <div className="form-group">
                  <label className="form-label" htmlFor="cv">Upload CV</label>
                  <input
                    type="file"
                    className="form-input"
                    id="cv"
            ...
            <div className="info-section">
              ...
              <div className="info-block">
                <h3 className="info-heading">Office Address:</h3>
